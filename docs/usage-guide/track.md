...
>>> [media.clips_metadata['music_canonical_id'] for media in (await cl.reels(amount=10))]
...
>>> (await cl.track_info_by_canonical_id(18159860503036324)).dict()
{
'id': '2398788493765573',
...
>>> track_uri = (await cl.track_info_by_canonical_id(18159860503036324)).uri
...
>>> await cl.track_download_by_url(track_uri, folder="/tmp")
PosixPath('/tmp/84846439_2484536748531420_3971102873273499648_n.m4a')

>>> (await cl.search_music("love"))[0].dict()
{
'id': '354372829354341',
