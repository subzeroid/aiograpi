...
WORKFLOW_PATH = REPO_ROOT / ".github/workflows/python-package.yml"
...
def test_live_job_keeps_fork_and_pull_request_secret_isolation():
    assert LIVE_JOB["if"] == (
        "(github.event_name == 'push' || github.event_name == 'workflow_dispatch') "
        "&& github.repository == 'subzeroid/aiograpi'"
    )
