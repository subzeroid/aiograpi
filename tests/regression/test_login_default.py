...
class LoginDefaultRegressionTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_login_follows_caa_fallback_instruction_through_legacy_flow(self):
        ...
        self.assertTrue(await self.client.login("user", "password"))
    ...
    async def test_login_preserves_legacy_failure_after_caa_fallback_instruction(self):
        self.client.bloks_caa_login = AsyncMock(
            return_value=self.caa_outcome_with_actions(
                ["CAA_LOGIN_FALLBACK:fallback_triggered"],
                reason="",
        ...
        self.client.pre_login_flow = AsyncMock(return_value=True)
        self.client.password_encrypt = AsyncMock(return_value="encrypted")
        self.client.private_request = AsyncMock(
    ...
    async def test_login_reports_caa_action_markers_when_no_fallback_is_requested(self):
        self.client.bloks_caa_login = AsyncMock(
            return_value=self.caa_outcome_with_actions(
