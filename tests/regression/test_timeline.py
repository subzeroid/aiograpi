...
class TimelineRegressionTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_timeline_feed_uses_configured_timezone_name_and_push_state(self):
    ...
    async def test_get_timeline_feed_accepts_timezone_and_push_constructor_kwargs(self):
    ...
    async def test_get_timeline_feed_derives_timezone_name_from_offset(self):
        client = Client()
        client.private_request = AsyncMock(return_value={"feed_items": []})
