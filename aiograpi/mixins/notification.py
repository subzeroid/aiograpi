...
class NotificationMixin:
    ...
    async def notification_settings(self, content_type: str, setting_value: str) -> bool:
        ...
        result = await self.private_request("notifications/change_notification_settings/", data=data)
        return result.get("status") == "ok"

    async def notification_disable(self) -> bool:
        """
    ...
    async def notification_like_and_comment_on_photo_user_tagged(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
        ...
        if setting_value not in SETTING_VALUE_ITEMS:
            raise UnsupportedSettingValue(setting_value, SETTING_VALUE_ITEMS)
        return await self.notification_settings("like_and_comment_on_photo_user_tagged", setting_value)

    async def notification_user_tagged(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_comment_likes(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_first_post(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_new_follower(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_follow_request_accepted(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
        ...
        if setting_value not in SETTING_VALUE_ITEMS:
            raise UnsupportedSettingValue(setting_value, SETTING_VALUE_ITEMS)
        return await self.notification_settings("follow_request_accepted", setting_value)

    async def notification_connection(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
        ...
        if setting_value not in SETTING_VALUE_ITEMS:
            raise UnsupportedSettingValue(setting_value, SETTING_VALUE_ITEMS)
        return await self.notification_settings("connection_notification", setting_value)

    async def notification_tagged_in_bio(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_pending_direct_share(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_direct_share_activity(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_direct_group_requests(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_video_call(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_live_broadcast(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_felix_upload_result(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_view_count(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_fundraiser_creator(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_fundraiser_supporter(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_reminders(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_announcements(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
    ...
    async def notification_report_updated(self, setting_value: SETTING_VALUE = "off") -> bool:
        """
