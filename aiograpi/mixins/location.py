...
class LocationMixin(ClientMixin):
    ...
    async def location_info(self, location_pk: int) -> Location:
        ...
        Location
            An object of Location
        """
        return await self.location_info_v1(location_pk)
    ...
    async def location_guides_v1(self, location_pk: int) -> List[Guide]:
        """
        ...
        result = await self.private_request(f"guides/location/{location_pk}/")
