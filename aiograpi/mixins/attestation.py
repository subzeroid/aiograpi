...
# IGUSDIDRegistrationMutation in the Android 428 app profile emulated by aiograpi.
...
class DeviceAttestationMixin(ClientMixin):
    ...
    async def usdid_register(self, client_doc_id: str = USDID_REGISTRATION_CLIENT_DOC_ID) -> bool:
    ...
    async def attestation_create_android_keystore(self, key_hash: str = "", domain: Optional[str] = None) -> Dict:
        ...
        result = await self.private_request("attestation/create_android_keystore/", **kwargs)
