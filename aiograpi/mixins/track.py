...
class TrackMixin(ClientMixin):
    ...
    async def music_in_feed_audio_browser(self, browse_session_id: Optional[str] = None) -> Dict:
        """
    ...
    async def music_verify_original_audio_title(self, original_audio_name: str) -> bool:
        """
    ...
    async def _feed_music_params(
        ...
        if alacorn_session_id is None:
            alacorn_session_id = (await self.music_in_feed_audio_browser()).get("alacorn_session_id")
