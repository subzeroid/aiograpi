...
from aiograpi.types import Hashtag, Location, Media, Track, UserShort
...
class FbSearchMixin(ClientMixin):
    ...
    async def media_search(self, query: str, amount: int = 27) -> List[Media]:
        """
        ...
        while True:
            ...
            result = await self.fbsearch_topsearch_v2(query, **kwargs)
